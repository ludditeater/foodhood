...
public class RetrieveChefMenuItemsAsyncTask extends AsyncTask<String, Void, String> {
	ChefMenuListAdapter currAdapter;
	Context context;

	public RetrieveChefMenuItemsAsyncTask(ChefMenuListAdapter adapter, Context context) {
	...
	protected String doInBackground(String... params) {
		...
		String url = ConnectionHelper.IP_PORT_CONTEXT + "/chefboard/getMenuByUser";
