...
public class RetrieveChefOrdersHistoryAsyncTask extends AsyncTask<String, Void, String> {
	ChefOrderHistoryListAdapter currAdapter;
	Context context;

	public RetrieveChefOrdersHistoryAsyncTask(ChefOrderHistoryListAdapter adapter, Context context) {
	...
	protected String doInBackground(String... params) {
		...
		postParameters.add(new BasicNameValuePair("chefId", currUser.getUsername()));
		String url = ConnectionHelper.IP_PORT_CONTEXT + "/itemsOrdered/getHistoryForChef";
